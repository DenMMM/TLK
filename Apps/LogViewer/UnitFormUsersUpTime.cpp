...
bool TFormUsersUpTime::Open(
	...
	const MLogRecords::const_iterator iBegin_,
	const MLogRecords::const_iterator iEnd_)
{
	...
	for ( const auto &Time: Times )
	{
		...
		Item->ImageIndex=-1;
		Item->Data=const_cast<MUserUpTime*>(&Time);
...
{
	auto &Time1=*reinterpret_cast<const MUserUpTime*>(Item1->Data);
	auto &Time2=*reinterpret_cast<const MUserUpTime*>(Item2->Data);
	__int64 time1, time2;
